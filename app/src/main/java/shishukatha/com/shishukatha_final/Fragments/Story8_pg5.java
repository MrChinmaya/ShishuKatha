 ...
 */
public class Story8_pg5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v2= inflater.inflate(R.layout.fragment_story8_pg5, container, false);
        ...
        startmenu=v2.findViewById(R.id.startmenu85);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Story8_pg4 page4=new Story8_pg4();
...
//                feedintent.putExtra("data","Story8");
