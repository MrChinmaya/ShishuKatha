 ...
 */
public class Story5_pg5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v2= inflater.inflate(R.layout.fragment_story5_pg5, container, false);
        narate= MediaPlayer.create(getActivity(),R.raw.s5a5);
        ...
        startmenu=v2.findViewById(R.id.startmenu55);
...
//                feedintent.putExtra("data","Story5");
