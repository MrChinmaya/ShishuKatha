 ...
 */
public class Story4_pg3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v2= inflater.inflate(R.layout.fragment_story4_pg3, container, false);
        narate= MediaPlayer.create(getActivity(),R.raw.s4a3);
        ImageButton prev=(ImageButton)v2.findViewById(R.id.imageButton14);
        startmenu=v2.findViewById(R.id.startmenu43);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Story4_pg2 page2=new Story4_pg2();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Story4_pg4 page4=new Story4_pg4();
                FragmentManager manager=getFragmentManager();
                manager.beginTransaction()
