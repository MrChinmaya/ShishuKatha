 ...
 */
public class Story2_pg2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v2= inflater.inflate(R.layout.fragment_story2_pg2, container, false);
        narate= MediaPlayer.create(getActivity(),R.raw.s2a2);
        ImageButton next=(ImageButton)v2.findViewById(R.id.imageButton9);
        startmenu=v2.findViewById(R.id.startmenu22);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Story2_pg1 page1=new Story2_pg1();
                FragmentManager manager=getFragmentManager();
                manager.beginTransaction()
