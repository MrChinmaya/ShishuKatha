 ...
 */
public class Story3_pg3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v2= inflater.inflate(R.layout.fragment_story3_pg3, container, false);

        ImageButton prev=(ImageButton)v2.findViewById(R.id.imageButton14);
        startmenu=v2.findViewById(R.id.startmenu33);
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Story3_pg2 page2=new Story3_pg2();
