 ...
 */
public class Story5_pg2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v2= inflater.inflate(R.layout.fragment_story5_pg2, container, false);
        narate= MediaPlayer.create(getActivity(),R.raw.s5a2);
        ImageButton prev=(ImageButton)v2.findViewById(R.id.imageButton14);
        startmenu=v2.findViewById(R.id.startmenu52);
