 ...
 */
public class Story7_pg1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v2= inflater.inflate(R.layout.fragment_story7_pg1, container, false);

        ImageButton next=(ImageButton)v2.findViewById(R.id.imageButton9);
        startmenu=v2.findViewById(R.id.startmenu71);
