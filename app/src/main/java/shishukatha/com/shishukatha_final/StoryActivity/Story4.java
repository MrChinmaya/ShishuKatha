...
import shishukatha.com.shishukatha_final.Fragments.Story4_pg1;
...
//        AB.hide();// remove title
        ...
        Intent intent= new Intent(Story4.this, Feedback.class);
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Story4.this, StoryMenu.class));
        finish();
