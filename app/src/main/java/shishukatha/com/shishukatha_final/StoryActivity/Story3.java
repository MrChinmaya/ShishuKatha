...
import shishukatha.com.shishukatha_final.Fragments.Story3_pg1;
...
//        AB.hide();// remove title
        ...
        Intent intent= new Intent(Story3.this, Feedback.class);
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Story3.this, StoryMenu.class));
        finish();
    }
}
