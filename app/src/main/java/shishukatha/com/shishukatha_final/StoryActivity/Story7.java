...
import shishukatha.com.shishukatha_final.Fragments.Story7_pg1;
...
//        AB.hide();// remove title
        ...
        Intent intent= new Intent(Story7.this, Feedback.class);
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Story7.this, StoryMenu.class));
        finish();
    }
}
