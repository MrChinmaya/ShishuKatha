...
import shishukatha.com.shishukatha_final.Fragments.Story6_pg1;
...
//        AB.hide();// remove title
        ...
        Intent intent= new Intent(Story6.this, Feedback.class);
        intent.putExtra("userid",userid);

        Story6_pg1 page1=new Story6_pg1();
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Story6.this, StoryMenu.class));
        finish();
