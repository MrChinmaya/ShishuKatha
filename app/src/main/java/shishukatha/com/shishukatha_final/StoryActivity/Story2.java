...
import shishukatha.com.shishukatha_final.Fragments.Story2_pg1;
...
//        AB.hide();// remove title
        ...
        Intent intent= new Intent(Story2.this, Feedback.class);
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Story2.this, StoryMenu.class));
        finish();
